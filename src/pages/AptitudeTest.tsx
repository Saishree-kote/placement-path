...
import { Clock, ChevronRight, CheckCircle, Brain, Sparkles, Loader2, Play, Building } from "lucide-react";
                    ...
                    <div className="mt-8 flex justify-between items-center">
                      ...
                      <div className="flex gap-3">
                        {sessionType === "unlimited" && (
                          <Button variant="outline" onClick={() => setPhase("result")} className="rounded-xl border-border/50">
                            Finish Now
                          </Button>
                        )}
                        <Button
                          ...
                          className="rounded-xl bg-primary text-primary-foreground btn-glow px-8"
                        >
              ...
              <GlassCard className="text-center py-10">
                ...
                <div className="flex gap-4 justify-center">
                  <Button
                    ...
                    className="rounded-xl bg-primary text-primary-foreground btn-glow px-10 h-10"
                  >
                    Try Again
                  </Button>
                  <Button onClick={() => { setPhase("review"); setCurrentQ(0); }} variant="outline" className="rounded-xl border-border/50 px-10">
                    Review Answers
                  </Button>
                </div>
              </GlassCard>
                ...
                {questions.map((_, i) => {
                  ...
                  return (
                    <motion.button
                      ...
                      className={`w-10 h-10 rounded-xl border flex items-center justify-center text-xs font-bold transition-all duration-300 ${isCurrent
                  ...
                  <div className="flex gap-2">
                    ...
                    {questions[currentQ].company && (
                      <span className="text-xs font-bold px-2 py-1 rounded-md bg-secondary/10 text-secondary border border-secondary/20">
                        {questions[currentQ].company.name}
                      </span>
                    )}
                  </div>
                ...
                <div className="space-y-3 mb-8">
                  {questions[currentQ].options.map((opt, i) => {
                    ...
                    return (
                      <div
                        key={i}
                        className={`p-4 rounded-xl border flex items-center justify-between ${isCorrect
